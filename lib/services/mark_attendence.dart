...
Future<String> markAttendance(String courseId, {String sessionId = "", int timeout = 10}) async {
  ...
  // Increment the attendance count for the course
  DocumentReference courseDocRef = FirebaseFirestore.instance.collection('Courses').doc(courseId);
  await courseDocRef.update({
    'attendanceCount': FieldValue.increment(1),
  });
  return "Attendance incremented successfully";
}